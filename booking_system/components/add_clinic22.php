                ...
                <?php if (!empty($clinics)): ?>
                    <?php foreach ($clinics as $clinic): ?>
                        <tr data-id="<?= htmlspecialchars($clinic['id']) ?>">
                            <!-- Governorate -->
                            <td class="editable" data-field="governorate"><?= htmlspecialchars($clinic['governorate']) ?></td>
                            <!-- City -->
                            ...
                            <!-- Days of the Week -->
                            <td class="editable" data-field="day_of_week"><?= htmlspecialchars($clinic['day_of_week']) ?></td>
                            <!-- Actions -->
                            <td>
                                ...
                                <form action="delete_clinic.php" method="POST" style="display:inline;">
                                    ...
                                    <button type="submit" class="btn-delete"
                                        onclick="return confirm('هل أنت متأكد من حذف هذه العيادة؟');">حذف</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
